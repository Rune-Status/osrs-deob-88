...
public class Def8 extends Node2 {
	...
	public static int method700(final byte[] var0, final int var1) {
		return Class41.clever(var0, 0, var1);
	}
	...
	void method702(final RSBuf var1, final int var2) {
		if (var2 == 1)
			aChar1449 = (char) var1.readByteU();
		else if (var2 == 2)
			aChar1445 = (char) var1.readByteU();
		else if (var2 == 3)
			aString1446 = var1.readStr2();
		else if (var2 == 4)
			anInt1442 = var1.readInt2(-1021237136);
		else {
			int var3;
			if (var2 == 5) {
				anInt1447 = var1.readShortU();
				anIntArray1448 = new int[anInt1447];
				aStringArray1450 = new String[anInt1447];

				for (var3 = 0; var3 < anInt1447; ++var3) {
					anIntArray1448[var3] = var1.readInt2(-2147263524);
					aStringArray1450[var3] = var1.readStr2();
				}
			} else if (var2 == 6) {
				anInt1447 = var1.readShortU();
				anIntArray1448 = new int[anInt1447];
				...
				for (var3 = 0; var3 < anInt1447; ++var3) {
					anIntArray1448[var3] = var1.readInt2(659503051);
					anIntArray1451[var3] = var1.readInt2(1118405470);
				}
			}
		}

public class Class104 {
	public static short[] aShortArray800 = new short[] { (short) 6798, (short) 8741, (short) 25238, (short) 4626,
			(short) 4550 };
	public static short[][] aShortArrayArray802 = new short[][] {
	...
	public static short[] aShortArray801 = new short[] { (short) -10304, (short) 9104, (short) -1, (short) -1,
			(short) -1 };
	public static short[][] aShortArrayArray803 = new short[][] {
	...
	public static boolean method405(final int var0) {
		return (var0 & 1) != 0;
	}
}

...
public class Def5 extends Class124_Sub22 {
	...
	static final boolean method705(final byte[] var0, final int var1, final int var2) {
		...
		label69: while (true) {
			final int var7 = var6.getsmart((byte) 94);
			if (var7 == 0)
				return var3;
			...
			while (true) {
				...
				while (!var4) {
					...
					if ((var8 > 0) && (var10 > 0) && (var8 < 103) && (var10 < 103)) {
						final Def6 var5 = Def13.method736(var9);
	...
	public static Somet1 method707(final byte[] var0) {
		if (null == var0)
			return null;
		else {

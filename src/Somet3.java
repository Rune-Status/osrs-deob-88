public class Somet3 {
			...
			for (int var5 = 0; var5 < 7; ++var5)
				for (int var6 = 0; var6 < Applet_Sub1.anInt1980; ++var6) {
					...
					if ((var7 != null) && !var7.aBool1361 && (((var3 ? 7 : 0) + var5) == var7.anInt1362)) {
						var1[client.anIntArray777[var5]] = var6 + 256;
						break;
					}
				}
		}
	...
	public void method395(final int var1, final boolean var2) {
		if ((var1 != 1) || !aBool779) {
			int var3 = anIntArray785[client.anIntArray777[var1]];
			if (var3 != 0) {
				var3 -= 256;
				...
				anIntArray785[client.anIntArray777[var1]] = var3 + 256;
				method398();
			}
		}
	}
	...
	public void method396(final int var1, final boolean var2) {
		...
		if (!var2)
			do {
				--var3;
				if (var3 < 0)
					var3 = client.aShortArrayArray783[var1].length - 1;
			...
			do {
				++var3;
				if (var3 >= client.aShortArrayArray783[var1].length)
					var3 = 0;
	...
	public void method397(final RSBuf var1) {
		...
		for (var2 = 0; var2 < 7; ++var2) {
			final int var3 = anIntArray785[client.anIntArray777[var2]];
			if (var3 == 0)
				var1.writeByte(-1);
			else
	...
	public Class124_Sub22_Sub19_Sub7 method399(final Def12 var1, final int var2,
		...
		if (active != -1)
			return Class34.getNpcDef(active, 1547564157).method645(var1, var2, var3, var4);
		else {
			long var6 = aLong781;
			...
			Class124_Sub22_Sub19_Sub7 var9 = (Class124_Sub22_Sub19_Sub7) client.aClass113_786.forId(var6);
			if (var9 == null) {
				boolean var15 = false;
				...
				if (var15) {
					if (-1L != aLong787)
						var9 = (Class124_Sub22_Sub19_Sub7) client.aClass113_786.forId(aLong787);
				...
				if (var9 == null) {
					...
					for (var5 = 0; var5 < 5; ++var5) {
						if (anIntArray778[var5] < client.aShortArrayArray783[var5].length)
							var18.method951(client.aShortArray782[var5], client.aShortArrayArray783[var5][anIntArray778[var5]]);

						if (anIntArray778[var5] < client.aShortArrayArray784[var5].length)
							var18.method951(Class56_Sub2.aShortArray1085[var5],
									client.aShortArrayArray784[var5][anIntArray778[var5]]);
					}

					var9 = var18.method945(64, 850, -30, -50, -30);
					client.aClass113_786.map(var9, var6);
					aLong787 = var6;
				}
			}
	...
	Model method400() {
		if (active != -1)
			return Class34.getNpcDef(active, 1846943511).method641();
		else {
			boolean var8 = false;
			...
			if (var8)
				...
				for (var4 = 0; var4 < 5; ++var4) {
					if (anIntArray778[var4] < client.aShortArrayArray783[var4].length)
						var6.method951(client.aShortArray782[var4], client.aShortArrayArray783[var4][anIntArray778[var4]]);

					if (anIntArray778[var4] < client.aShortArrayArray784[var4].length)
						var6.method951(Class56_Sub2.aShortArray1085[var4],
								client.aShortArrayArray784[var4][anIntArray778[var4]]);
				}
	...
	public int npcThing() {
		return active == -1
				...
				: 305419896 + Class34.getNpcDef(active, 1433944503).npcidmaybe;
	}
}
